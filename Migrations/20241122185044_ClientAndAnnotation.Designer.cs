...
namespace RazorPagesZenSpaCh7.Migrations
{
    ...
    [Migration("20241122185044_ClientAndAnnotation")]
    partial class ClientAndAnnotation
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RazorPagesZenSpaCh7.Models.ClientService", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = 1,
                            ClientID = 1,
                            Date = new DateTime(2024, 11, 22, 13, 50, 44, 867, DateTimeKind.Local).AddTicks(1112),
                            ServicesID = 1
                        },
                        new
                        {
                            ID = 2,
                            ClientID = 2,
                            Date = new DateTime(2024, 11, 22, 13, 50, 44, 867, DateTimeKind.Local).AddTicks(1168),
                            ServicesID = 7
                        },
                        new
                        {
                            ID = 3,
                            ClientID = 1,
                            Date = new DateTime(2024, 11, 22, 13, 50, 44, 867, DateTimeKind.Local).AddTicks(1170),
                            ServicesID = 5
                        });
                });
