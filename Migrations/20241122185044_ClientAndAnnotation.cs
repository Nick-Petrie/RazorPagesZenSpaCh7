...
{
    /// <inheritdoc />
    public partial class ClientAndAnnotation : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2024, 11, 22, 13, 50, 44, 867, DateTimeKind.Local).AddTicks(1112), 1 },
                    { 2, 2, new DateTime(2024, 11, 22, 13, 50, 44, 867, DateTimeKind.Local).AddTicks(1168), 7 },
                    { 3, 1, new DateTime(2024, 11, 22, 13, 50, 44, 867, DateTimeKind.Local).AddTicks(1170), 5 }
                });
